...
exports.findExtendedAction = exports.findAction = exports.allActions = exports.addAction = void 0;
const semver = require("semver");
const actions = [];
function addAction(action) {
  
    actions.push(action);
    console.log("ac "+ JSON.stringify(actions));
}
...
function allActions(opts) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof whitelistNames === "string" && whitelistNames.length > 0) {
            ...
            console.log("acif "+ JSON.stringify(actions));
